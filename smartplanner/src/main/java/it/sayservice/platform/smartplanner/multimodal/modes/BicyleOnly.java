...
/**
 * BikeOnly independant mode.
 * 
 * @author nawazk
 * 
 */
public class BicyleOnly {

	private static final transient Logger logger = LoggerFactory.getLogger(BicyleOnly.class);
	/** list of itineraries. **/
	...
	/**
	 * constructor to be used in context.
	 * 
	 * @param otpCon
	 *            OTPConnector
	 * @param itnHelper
	 *            ItineraryBuildHelper
	 */
	public BicyleOnly(OTPConnector otpCon, ItineraryBuildHelper itnHelper) {
...
//		}
		...
		preProcessParams.put(Constants.SP_RQ_USERMODE, TType.BICYCLE.name());
