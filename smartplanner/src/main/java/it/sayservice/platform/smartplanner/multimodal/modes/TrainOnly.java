...
/**
 * Train Only Independent Mode.
 * 
 * @author nawazk
 */
public class TrainOnly {
	 ...
	 * @param itnHelper
	 */
	public TrainOnly(OTPConnector otpCon, ItineraryBuildHelper itnHelper) {
	...
	public List<Itinerary> getItinerary(String router, HashMap<String, Object> parameters) throws IOException {
		...
		otpMap.put(Constants.OTP_RQ_MODE, Constants.MODES.TRAIN.toString());
		...
		preProcessParams.put(Constants.SP_RQ_USERMODE, TType.TRAIN.name());
